...
#### 📝 Moved to Draft
The following PRs were automatically removed as they were moved to draft status:

- ~~[Upstream PR #8163](https://github.com/jellyfin/jellyfin-web/pull/8163)~~ (became draft on 2026-07-18)
